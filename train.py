...
flags.DEFINE_string('name', 'log', 'type log name')
flags.DEFINE_float('alpha', 1, 'confidence factor')
flags.DEFINE_float('beta', 1, 'probability factor')
flags.DEFINE_float('gamma', -1, 'giou scale factor')
